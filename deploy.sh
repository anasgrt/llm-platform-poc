...
log ""
log "Deploy workloads through ArgoCD after pushing ../LLM-PLATFORM-POC-ARGOCD:"
log "  vagrant ssh control --command \"kubectl apply -f https://raw.githubusercontent.com/anasgrt/LLM-PLATFORM-POC-ARGOCD/main/argocd/app-dev.yaml\""
log ""
log "Workload URLs after ArgoCD sync:"
...
log ""
log "Monitor GitOps workloads after sync:"
