...
log ""
log "The dev ArgoCD Application is applied automatically from the GitOps repository:"
log "  https://raw.githubusercontent.com/anasgrt/LLM-PLATFORM-POC-ARGOCD/main/argocd/app-dev.yaml"
log ""
